...
export default function Body(props) {
    ...
    return (
        <div className="body container">
            ...
            <section className="text--section proficiency pro">
                <h3>
                    Hard skills
                </h3>
                <ul>
            ...
            <section className="text--section proficiency p--langs">
                <h3>
                ...
                <div className="rating--table">
                    ...
                    <div className="rating--row">
                        <p>HTML5</p>
                        <div className="rating--value">{rate(3)}</div>
                    </div>
                    <div className="rating--row">
                        <p>CSS</p>
                    ...
                    <div className="rating--row">
                        <p>C</p>
                        <div className="rating--value">{rate(4)}</div>
                    </div>
                    <div className="rating--row">
                        <p>C++</p>
                        <div className="rating--value">{rate(3)}</div>
            ...
            <section className="text--section frameworks">
                <h3>
            ...
            <div className="s--skills">
                <section className="text--section proficiency soft--skills">
                    <h3>
                        Soft skills
                    </h3>
                    <ul>
                ...
                <section className="text--section location">
                    <h3>
                        Location
                    </h3>
                    <p>
                ...
                <section className="text--section langs">
                    <h3>
                        Languages
                    </h3>
                    <div className="rating--table">
